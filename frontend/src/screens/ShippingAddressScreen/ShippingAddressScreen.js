...
export default function ShippingAddressScreen() {
  ...
  return (
    ...
    <div className='container-shipping'>
      ...
      <div className="container small-container  animate__animated animate__fadeIn ">
        <h1 className="my-5 cheackout-title">Shipping Address</h1>
        <Form onSubmit={submitHandler}>
          <Form.Group className="mb-3" controlId="fullName">
            <Form.Label className='checkout-label '>Full Name</Form.Label>
            <Form.Control
              className='cheackout-input'
              value={fullName}
          ...
          <Form.Group className="mb-3" controlId="postalCode">
            <Form.Label className='checkout-label'>Postal Code</Form.Label>
            <Form.Control
             className='cheackout-input'
              value={postalCode}
          ...
          <div className="mb-3">
            <Button variant="primary" type="submit" className='shippeng-btn'>
              Continue
            </Button>
          </div>
        </Form>
